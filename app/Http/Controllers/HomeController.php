...
//        $categories = Category::with('menus')->get();
        ...
        $blogs=Blog::all();
        $faqs=Faq::all();
        return view('front.index',compact('banner','faqs','counters','blogs','about','services','plans','testimonials','teams'));
      }
      public function about(){
          ...
          $counters=Counter::all();
          $faqs=Faq::all();
          return view('front.about',compact('about','teams' ,'counters','faqs'));
      }
